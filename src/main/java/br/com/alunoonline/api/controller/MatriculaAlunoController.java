...
public class MatriculaAlunoController {
    ...
    @ResponseStatus(HttpStatus.NO_CONTENT)
    public void atualizarNotas(@PathVariable Long id, @RequestBody AtualizarNotasRequestsDTO atualizarNotasRequestsDTO){
        matriculaAlunoService.atualizarNotas(id, atualizarNotasRequestsDTO);
    }
}
